...
<head>
		...
		<meta name="description" content="AppSet - App Landing Pages Pack"/>
	...
	<body>
		...
		<div id="page" class="page">
			...
			<!-- FEATURES-4
			============================================= -->
			<section id="features-4" class="wide-60 featuress-section division">
				<div class="container">
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">							
							<div class="statistic-block box-icon wow fadeInUp" data-wow-delay="0.3s">

								<!-- Icon -->
								<span class="green-color ti-Line-Download-1"></span>

								<!-- Data -->
								<p class="statistic-number txt-700">3,<span class="count-element">438</span></p>
								<p class="txt-500">Downloads</p>
			...
			<section id="video-2" class="pb-100 video-section division d-none">
				<div class="bg-scroll pt-100 bg-inner bg-lightgrey division">	
					<div class="container">
						...
						<!-- VIDEO PREVIEW -->	
				 		<div class="row">
				 			<div class="col-md-10 col-lg-10 offset-md-1 offset-lg-1 text-center">
			...
			<!-- CONTENT-7
			============================================= -->
			<section id="content-7" class="wide-60 content-section">
				<div class="container">
					<div class="row d-flex align-items-center">
						...
						<div class="col-md-7 col-lg-6">
							<div class="content-txt">
								...
								<!-- APP DEVICES -->	
								<div class="app-devices clearfix wow fadeInUp" data-wow-delay="1s">	
			...
			<!-- CONTENT-4
			============================================= -->
			<section id="content-4" class="bg-scroll bg-green pt-100 content-section division">
						...
						<div class="col-md-6">
					 	...
					 	<div class="col-md-6">
					 		<div class="content-txt">
					 			...
					 			<!-- Title -->	
								<h3 class="h3-xl wow fadeInUp" data-wow-delay="0.3s">
								   Stunning landing page for your App
								</h3>

								<!-- Text -->	
								<p class=" wow fadeInUp" data-wow-delay="0.5s">
								   An nullam tempor sapien, eget gravida donec enim ipsum porta justo integer at odio velna vitae
								   auctor integer congue magna undo impedit. Gravida magna lacus odio ac risus auctor tempus
								</p>
								...
								<ul class="content-list">
									...
									<li class=" wow fadeInUp" data-wow-delay="0.8s">
									   Tempor sapien gravida donec enim ipsum blandit
									</li>

									<li class=" wow fadeInUp" data-wow-delay="0.9s">
										Magna at pretium purus pretium ligula rutrum luctus risus ultrice nullam tempor sapien
									    gravida donec  porta 
									</li>
				 		...
				 		<div class="col-md-10 col-lg-8 offset-md-1 offset-lg-2">
				 			<div class="form-holder text-center">
								<form name="registerform" class="row register-form">
									...
									<div class="col-lg-12 register-form-msg">
